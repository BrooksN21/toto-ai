...
def _load_collection_by_id(
    ...
    collection = ExternalCollectionSnapshot(
        ...
        quota_last_cost=run.quota_last_cost,
        status=run.status,
        events=events,
...
def _collection_run_row(
    ...
    return ExternalCollectionRun(
        ...
        quota_limit=collection.quota_limit,
        quota_remaining=collection.quota_remaining,
        quota_used=collection.quota_used,
        quota_last_cost=collection.quota_last_cost,
...
def _event_disposition_row(
    ...
    return ExternalEventDisposition(
        ...
        target_bk_probability_1=event.target_bk_probability_1,
        target_bk_probability_x=event.target_bk_probability_x,
        target_bk_probability_2=event.target_bk_probability_2,
...
def _event_record_from_row(
    ...
    return ExternalEventDispositionRecord(
        ...
        provider_event_source_endpoint=row.provider_event_source_endpoint,
        provider_event_request_fingerprint=(
            row.provider_event_request_fingerprint
        ),
        ...
        target_bk_probability_1=row.target_bk_probability_1,
        target_bk_probability_x=row.target_bk_probability_x,
        target_bk_probability_2=row.target_bk_probability_2,
