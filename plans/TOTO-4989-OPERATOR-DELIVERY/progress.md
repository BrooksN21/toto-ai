# TOTO-4989 operator delivery progress

- [x] Atomic-final READY preparation regression restored.
- [x] Persisted cutoff survives unresolved-only retries.
- [x] Live drawing-4989 retry returns deferred code 75, not fatal code 2.
- [x] Scheduler schema v8 starts atomic final at T-25.
